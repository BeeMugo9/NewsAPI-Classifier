# NewsAPI-Classifier
This repository holds a Python notebook that retrieves news articles from the public NewsAPI about humanitarian and medical situations in selected countries.
